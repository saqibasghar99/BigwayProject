<div>
    <div class="card-controls sm:flex">
        <div class="w-full sm:w-1/2">
            ...
            @can('vehicletype_create')
                <x-csv-import route="{{ route('admin.vehicletypes.csv.store') }}" />
            @endcan
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-end">
                                    @can('vehicletype_show')
                                        <a class="btn btn-sm btn-info mr-2" href="{{ route('admin.vehicletypes.show', $vehicletype) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    @can('vehicletype_edit')
                                        <a class="btn btn-sm btn-success mr-2" href="{{ route('admin.vehicletypes.edit', $vehicletype) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan
                                    @can('vehicletype_delete')
