<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('user.email') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="email" id="email" name="email" required wire:model="user.email">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('user.password') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="password" name="password" id="password" required wire:model="user.password">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('user.contact') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="number" name="contact" id="password" required wire:model="user.contact">
        <div class="validation-message">
