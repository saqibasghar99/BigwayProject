...
class Edit extends Component
{
    ...
    public function mount(RouteHistory $routeHistory)
    {
        ...
        $this->vendor       = $this->routeHistory->vendor()->pluck('id')->toArray();
        $this->vehicle_type = $this->routeHistory->vehicleType()->pluck('id')->toArray();
        $this->route        = $this->routeHistory->route()->pluck('id')->toArray();
        $this->initListsForFields();
    }

    public function render()
    {
        return view('livewire.route-history.edit');
    }
